...
#-keep public class * extends android.support.v4.widget.SwipeRefreshLayout
...
-keep public class * extends android.support.v7.widget.AppCompatActivity
#-keep public class * extends android.support.v7.widget.CardView
-keep class com.example.aboutImage.**{*;}
